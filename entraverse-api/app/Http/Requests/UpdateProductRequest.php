...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'variant_pricing.*.shared_variant_image_key' => ['sometimes', 'nullable', 'string', 'max:120', new NoHtml],
            'variant_pricing.*.variant_image_key' => ['sometimes', 'nullable', 'string', 'max:120', new NoHtml],
            'variant_pricing.*.variant_image' => ['sometimes', 'nullable', 'string', 'max:2048'],
