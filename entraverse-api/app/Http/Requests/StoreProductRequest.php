...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'variant_pricing.*.shared_variant_image_key' => ['nullable', 'string', 'max:120', new NoHtml],
            'variant_pricing.*.variant_image_key' => ['nullable', 'string', 'max:120', new NoHtml],
            'variant_pricing.*.variant_image' => ['nullable', 'string', 'max:2048'],
