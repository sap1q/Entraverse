...
class StockService
{
    ...
    public function listAllInventoryRows(array $filters = []): Collection
    {
        ...
        $allRows = $this->collectInventoryRows($search);
        ...
        return $allRows
            ->filter(fn (array $row): bool => strcasecmp((string) $row['warehouse'], $warehouseFilter) === 0)
            ->values();
    }
    ...
    private function collectInventoryRows(string $search = ''): Collection
    {
